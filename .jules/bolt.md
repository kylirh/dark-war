...
*Measurement verified:* In a benchmark instantiating/destroying vs pooling/clearing 2500 `Graphics` objects over 500 frames, pooling reduced median execution time from ~3200ms to ~1800ms (a ~43% improvement).
