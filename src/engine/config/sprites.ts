...
export const SPRITE_COORDS: Record<string, SpriteCoordinate> = {
  ...
  prototype_grass_flowers: { x: 1, y: 17 },
  prototype_dirt: { x: 2, y: 17 },
  prototype_stone: { x: 3, y: 17 },
  prototype_water_shallow: { x: 4, y: 17 },
  prototype_water_deep: { x: 5, y: 17 },
  prototype_cliff_step: { x: 6, y: 17 },
  prototype_cliff_tall: { x: 7, y: 17 },
  prototype_cliff_edge_north: { x: 8, y: 17 },
  prototype_cliff_edge_east: { x: 9, y: 17 },
  prototype_cliff_edge_south: { x: 10, y: 17 },
  prototype_cliff_edge_west: { x: 11, y: 17 },
  prototype_grass_alt: { x: 12, y: 17 },
  prototype_dirt_alt: { x: 13, y: 17 },
  prototype_stone_alt: { x: 14, y: 17 },
  prototype_water_alt: { x: 15, y: 17 },
  prototype_bridge_horizontal: { x: 8, y: 18 },
  prototype_stairs: { x: 9, y: 18 },
  prototype_garden: { x: 10, y: 18 },
  prototype_flowers: { x: 11, y: 18 },
  prototype_workshop: { x: 8, y: 20 },
  prototype_cave_mouth: { x: 11, y: 20 },
  prototype_tree: { x: 13, y: 20 },
...
export const SPRITE_FRAMES: Record<string, Partial<SpriteFrame>> = {
  ...
  prototype_stone: flatSprite,
  prototype_water_shallow: flatSprite,
  prototype_water_deep: flatSprite,
  prototype_cliff_step: flatSprite,
  prototype_cliff_tall: flatSprite,
  prototype_cliff_edge_north: flatSprite,
  prototype_cliff_edge_east: flatSprite,
  prototype_cliff_edge_south: flatSprite,
  prototype_cliff_edge_west: flatSprite,
  prototype_grass_alt: flatSprite,
  prototype_dirt_alt: flatSprite,
  prototype_stone_alt: flatSprite,
  prototype_water_alt: flatSprite,
  prototype_bridge_horizontal: flatSprite,
  prototype_stairs: flatSprite,
  prototype_garden: flatSprite,
  prototype_flowers: {
    ...singleCellBillboard,
    renderHeight: 32,
    shadow: "none",
